...
TEST_DATA_FILENAME = DATA_DIR + DATASET + '/t10k-images'
TEST_LABELS_FILENAME = DATA_DIR + DATASET + '/t10k-labels'
TRAIN_DATA_FILENAME = DATA_DIR + DATASET + '/train-images'
TRAIN_LABELS_FILENAME = DATA_DIR + DATASET + '/train-labels'
...
#https://www.myemergency.herokuapp.com/
